...
export default function getFileType(extension?: string, isFolder: boolean = false): ICloudioType {
    ...
    if (['py', 'java', 'js', 'cpp', 'cs', 'php', 'rb', 'swift', 'kt', 'm', 'go', 'rs', 'scala', 'pl', 'lua', 'ts', 'sql', 'html', 'css'].includes(extension)) return 'code';
